...
export default function ProductDetails () {
    ...
    function handleUpdateCart() {
        setSubmitting(true);
        //if no items or adding to exisiting item
        ...
        <Grid container spacing={6}>
            ...
            <Grid item xs={6}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={6}>
                        <TextField onChange={handleInputChange} variant="outlined" type="number" label='Quantity in Cart' fullWidth value={quantity}></TextField>
                    </Grid>
                    <Grid item xs={6}>
                        <LoadingButton 
                        //disable update if quantity is zero
                        disabled={item?.quantity === quantity || !item && quantity === 0} 
                        loading={submitting} onClick={handleUpdateCart} sx={{height:'55px'}} 
